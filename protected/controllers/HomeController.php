...
class HomeController extends Controller
{
	...
	public function actionInvestorFinancial()
	{
		$this->pageTitle = 'Investor Financial - '.$this->pageTitle;
		$this->layout='//layouts/column2';

		$this->render('investorfinancial', array(	
		));
	}

	public function actionNewsFront()
	{
		$this->pageTitle = 'News - '.$this->pageTitle;
		$this->layout='//layouts/column2';

		$this->render('newsfront', array(	
		));
	}

	public function actionInvestorReports()
	{
		$this->pageTitle = 'Investor Reports - '.$this->pageTitle;
		$this->layout='//layouts/column2';

		$this->render('investorreports', array(	
		));
	}

	public function actionInvestorFactsheet()
	{
		$this->pageTitle = 'Investor Factsheet - '.$this->pageTitle;
		$this->layout='//layouts/column2';

		$this->render('investorfactsheet', array(	
		));
	}
	...
	public function actionCase()
	{
		...
		$this->render('case-studies', array(
		));
	}

	public function actionNewsEvent()
	{
		$this->pageTitle = 'News and Event - '.$this->pageTitle;
		$this->layout='//layouts/column2';
	...
	public function actionFinancialDetail()
	{
		$this->pageTitle = 'Financial Detail - '.$this->pageTitle;
		$this->layout='//layouts/column2';

		$this->render('financialdetail', array(	
		));
	}
...
');
	...
	public function actionBusiness_detail()
	{
		$this->pageTitle = 'Business Detail - '.$this->pageTitle;
		$this->layout='//layouts/column2';

		$this->render('bussiness_detail', array(	
		));
	}
