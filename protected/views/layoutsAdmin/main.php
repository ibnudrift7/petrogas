    ...
    <div class="header">
        <div class="logo">
            <a href="<?php echo CHtml::normalizeUrl(array('/admin/site/index')); ?>">
                <img src="<?php echo Yii::app()->baseUrl; ?>/asset/backend/images/logo-markdesign-h.png" alt="Cms Chromatic" />
            </a>
        </div>
        <div class="headerinner">
            <ul class="headmenu">
                ...
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/about/index')); ?>">
                        <span class="head-icon fa fa-info"></span>
                        <span class="headmenu-label"><?php echo Tt::t('admin', 'About Us') ?></span>
                    </a>
                </li>
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/healty/index')); ?>">
                    <span class="head-icon fa fa-heart"></span>
                    <span class="headmenu-label"><?php echo Tt::t('admin', 'Healty') ?></span>
                    </a>
                </li>
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/gema/index')); ?>">
                    ...
                    <div class="userloggedinfo">
                        ...
                        */ ?>
                        <div class="userinfo">
                            ...
                            <ul>
                                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/administrator/edit')); ?>"><?php echo Tt::t('admin', 'Edit Profile') ?></a></li>
                                <?php /*
