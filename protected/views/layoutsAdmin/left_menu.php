<div class="leftmenu">        
    <ul class="nav nav-tabs nav-stacked">
        ...
        */ ?>
        ...
        <?php /*
        <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/gallery/index')); ?>"><span class="fa fa-image"></span> <?php echo Tt::t('admin', 'Gallery') ?></a></li>
        ...
        */ ?>
        ...
        <!-- <li>
            <a href="<?php echo CHtml::normalizeUrl(array('/admin/promoHightlight/index')); ?>"><span class="fa fa-image"></span> <?php echo Tt::t('admin', 'Home Spotlight') ?></a>
        </li> -->
        ...
        <li class="dropdown"><a href="<?php echo CHtml::normalizeUrl(array('/admin/blog/index')); ?>"><span class="fa fa-flag"></span> <?php echo Tt::t('admin', 'News & Events') ?></a>
            <ul>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/blog/index')); ?>">List News</a></li>
