...
<div class="widget">
<h4 class="widgettitle">Edit Project Development</h4>
<div class="widgetcontent">
	...
	<div class="row-fluid">
		<div class="span6">
			...
			'hint'=>'<b>Note:</b> Ukuran gambar adalah 56 x 56px. Gambar yang lebih besar akan ter-crop otomatis', 'style'=>"width: 100%")); ?>
			<?php if ($model->scenario == 'update'): ?>
			<div class="control-group">
				<label class="control-label">&nbsp;</label>
				<div class="controls">
					<img src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(56,56, '/images/category/'.$model->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
				</div>
			</div>
			<?php endif; ?>
		</div>
		<div class="span6">
			...
			'hint'=>'Background color hex code', 'placeholder'=> 'ex: #786767')); ?>
		</div>
	</div>
	<br>
