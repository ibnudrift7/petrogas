	...
	<div class="widget">
		...
		<div class="widgetcontent">
			...
			foreach ($modelDesc as $key => $value) {
			    ...
			    echo $form->textArea($value,'['.$lang->code.']content',array('class'=>'span11 redactor'));
			    ?>
			    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
			    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
				</div>
				...
				<?php
				echo $form->labelEx($value, '['.$lang->code.']benefit');
			    echo $form->textArea($value,'['.$lang->code.']benefit',array('class'=>'span11 redactor'));
			    ?>
			    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
			    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
				</div>
				...
				<?php
				echo $form->labelEx($value, '['.$lang->code.']application');
			    echo $form->textArea($value,'['.$lang->code.']application',array('class'=>'span11 redactor'));
			    ?>
			    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
			    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
				</div>
			...
			<div class="control-group">
				...
				<img class="img-polaroid" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(782,929, '/images/service/'.$model->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
				</div>
				</div>
			</div>
			<?php endif; ?>
			<div class="row-fluid">
				<div class="span6">
					<?php echo $form->textFieldRow($model, 'sorting', array('class'=>'form-control', 'hint'=> '*) isikan dengan angka')); ?>
				</div>
				<div class="span6">
