<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="widget">
		...
		<div class="widgetcontent">
			...
			<?php echo $form->dropDownListRow($model, 'topik_id', $res_product, array('class'=>'form-control span6', 'empty'=>'-- Choose Category --')); ?>
			<?php
			if ($model->scenario == 'insert') {
				$model->category_id = $_GET['category'];
			}
			?>
			<?php echo $form->hiddenField($model, 'category_id',array('class'=>'')); ?>
			...
			<div class="control-group">
				...
				<img class="img-polaroid" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(782,929, '/images/blog/'.$model->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
				</div>
				</div>
			</div>
			<?php endif; ?>
