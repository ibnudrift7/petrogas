...
<div class="widgetcontent">
	...
	<?php echo $form->textAreaRow($model,'intro_desc',array('rows'=>3, 'cols'=>50, 'class'=>'span5 redactor')); ?>

	<div class="divider15"></div>

	<?php echo $form->textAreaRow($model,'deskripsi',array('rows'=>3, 'cols'=>50, 'class'=>'span5 redactor')); ?>

	<div class="divider15"></div>
	
	<?php echo $form->textAreaRow($model,'kualifikasi',array('rows'=>4, 'cols'=>50, 'class'=>'span5 redactor')); ?>
