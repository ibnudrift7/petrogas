...
class ReportcatController extends ControllerAdmin
{
	...
	public function actionCreate()
	{
		...
		$nestedCategory = PrdCategory::model()->nested($dataNestedCategory['data'], 'reportcat');
	...
	public function actionDelete($id)
	{
			...
			PrdCategoryDescription::model()->deleteAll('category_id = :category_id', array(':category_id'=>$data->id));
			$data->delete();
